...
public class Smartphones extends javax.swing.JFrame {
    ...
    boolean found;
    String cat = "Smartphones";

    found = cat.equalsIgnoreCase(dataRow[1]);

    System.out.println("Category comparison result: " + found);  // Print the comparison result for debugging
